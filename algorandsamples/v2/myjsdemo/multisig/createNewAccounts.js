...
console.log("");
console.log("let  account1_mnemonic = \"" + account1_mnemonic + "\"");
console.log("let  account2_mnemonic = \"" + account2_mnemonic + "\"");
console.log("let  account3_mnemonic = \"" + account3_mnemonic + "\"");
console.log("let  account1 address = \"" + account1 + "\"");
console.log("let  account2 address = \"" + account2 + "\"");
console.log("let  account3 address = \"" + account3 + "\"");
// sandbox
...
// let  account1_mnemonic = "actor float tired slice holiday craft prefer shell enough fog girl assume edge employ piece address antenna kidney square chuckle example congress tell able ketchup"
// let  account2_mnemonic = "crumble foil love below clog way cluster first castle energy rich coin thing tribe skull sentence awful destroy main buyer cable warm welcome abstract excite"
// let  account3_mnemonic = "green inside final anchor antenna radio vintage rubber coil leaf anger insane round room moment industry basket entire lazy quiz enlist dad dilemma about program"
