...
public class GettingStartedASAIntegrations {
    ...
    private void printBalance(Account myAccount) throws Exception {
        ...
        com.algorand.algosdk.v2.client.model.Account accountInfo = respAcct.body();
        System.out.println(String.format("Account Balance: %d microAlgos for account %S", accountInfo.amount, accountInfo.address.toString()));
    ...
    public void transferAlgos(Account alice, Account bob) throws Exception {
        ...
        try {
            ...
            System.out.println(String.format("Bob's account balance after transaction w minimum balance of 203000 microalgos:"));        
            printBalance(bob);
        } catch (Exception e) {
    ...
    private void closeoutAccountAlgos(Account closeoutAccount) {
        ...
        try {
            ...
            String RECEIVER = "HZ57J3K46JIJXILONBBZOHX6BKPXEM2VVXNRFSUED6DKFD5ZD24PMJ3MVA";            
            Response < TransactionParametersResponse > resp = client.TransactionParams().execute();
            if (!resp.isSuccessful()) {
                throw new Exception(resp.message());
            }
    ...
    public static void main(String args[]) throws Exception {
        ...
        // plus 3000 for two transactions(optin , transfer asset, close out account)        
        ...
        // todo closetoaccount on Bob? 
        // Asset can be only de destroyed if Alice (cereator) has all the Assets 
